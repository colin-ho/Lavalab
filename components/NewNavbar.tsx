import {
    Box, Link as ChakraLink, Flex, Text, IconButton, Button, Stack, Collapse, Icon, Popover,
    PopoverTrigger, PopoverContent, useColorModeValue, Image, useDisclosure,
...
const MobileNavItem = ({ navItem }: MobileNavItemProps) => {
