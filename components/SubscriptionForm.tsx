...
export default function SubscriptionForm({ editableSub, setFormMode }: any) {
    ...
    const submitSubscription = async ({ title, content, price, interval, limit, dayConstrain, description }: any) => {
        ...
        try {
            ...
            if (editableSub) {
                const ref = firestore.collection('subscriptions').doc(editableSub.id);
                ...
                <form onSubmit={handleSubmit(submitSubscription)}>
                    ...
                    <Stack mt="20px" borderRadius="2xl" boxShadow="0px 16px 50px rgba(0, 0, 0, 0.07)" p="6" spacing="5">
                        ...
                        <FormControl id="title" isInvalid={errors.title?.message}>
                            ...
                            <Input placeholder="Morning Brew Subscription" type="text" {...register('title', {
                                required: { value: true, message: 'Subscription name is required' },
                        ...
                        <HStack spacing="10">
                            <FormControl h="100px" id="price" isInvalid={errors.price?.message}>
                                ...
                                <Input type="number" step="0.01" placeholder="19.99"{...register('price', { required: { value: true, message: 'Price is required' }, min: { value: 1, message: 'Price is too low' } })} />
                        ...
                        <FormControl id="content" isInvalid={errors.content?.message}>
                            ...
                            <Input type="text" placeholder="Coffee" {...register('content', {
                        ...
                        <FormControl id="description" isInvalid={errors.description?.message}>
                            ...
                            <Input type="text" placeholder="Delicious hot coffee everyday" {...register('description', {
                        ...
                        <FormControl id="limit" isInvalid={errors.limit?.message}>
                            ...
                            <Input type="number" placeholder="10" {...register('limit', {
                ...
                <Box boxShadow="0px 16px 50px rgba(0, 0, 0, 0.07)" alignSelf="center" w="sm" p="6" mt="90px" borderRadius="xl"  >
                    ...
                    <Box mt="20px" boxShadow="0px 16px 50px rgba(0, 0, 0, 0.07)" borderRadius="xl" overflow="hidden">
                        ...
                        <Flex direction="column" p="4" mb="20px">
                            <Text fontWeight="600">{watchAllFields.title ? watchAllFields.title : "Morning Brew Subscription"}{" from " + business?.businessName}</Text>
