...
import { Badge, Box, Flex, Heading, HStack, ListItem, Spacer, Stack, Text, UnorderedList, VStack } from '@chakra-ui/layout';
...
function SubscriptionItem({ subscription,setFormMode,setEditableSub }) {
    ...
    return (
      <div style={{marginleft:100}}>
        ...
        {subscription.published ? null: <button onClick={edit} className="btn-blue">Edit</button>}
      </div>
    );
}
...
function SubscriptionForm({ editableSub,setFormMode }) {
    ...
    return (
            <Flex direction={{base:"column",pxl:"row"}} >
                {console.log(errors)}
                <Flex direction="column" w={{base:"100%",pxl:"65%"}} justify="space-around" p="30px" pr={{base:"30px",pxl:"60px"}}>
                ...
                <Flex direction="column" pt="30px" pr={{base:"30px",pxl:"0px"}} pl={{base:"30px",pxl:"0px"}}>
